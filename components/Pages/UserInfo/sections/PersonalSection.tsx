    ...
    <div className="border-b border-gray-900/10 pb-12">
      ...
      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div className="sm:col-span-3">
          ...
          >
            First name <span className="text-red-500">*</span> {errors.firstName && (
        ...
        <div className="sm:col-span-3">
          <label
            ...
            className="block text-sm/6 font-medium text-gray-900"
          >
            Last name <span className="text-red-500">*</span>{errors.lastName && (
        ...
        <div className="sm:col-span-3">
          <label
            ...
            className="block text-sm/6 font-medium text-gray-900"
          >
            Country <span className="text-red-500">*</span> {errors.country && (
        ...
        <div className="sm:col-span-3">
          <label
            ...
            className="block text-sm/6 font-medium text-gray-900"
          >
            Gender <span className="text-red-500">*</span>{errors.gender && (
